      ...
      "/guide/v2/": [
        ...
        },
        {
          ...
          children: [
            ...
            "/guide/v2/2.3.route",
            "/guide/v2/2.4.etc",
            "/guide/v2/2.5.bind-gate",
            "/guide/v2/2.6.bind-node",
            "/guide/v2/2.7.single-thread",
            "/guide/v2/2.8.multiple-coroutines",
            "/guide/v2/2.9.actor",
            "/guide/v2/2.10.mode",
            "/guide/v2/2.11.error",
        ...
        },
        {
          ...
          children: [
            "/guide/v2/3.1.log",
            "/guide/v2/3.2.network",
            "/guide/v2/3.3.registry",
            "/guide/v2/3.4.locate",
            "/guide/v2/3.5.transport",
            "/guide/v2/3.6.crypto",
          ],
        },
        {
